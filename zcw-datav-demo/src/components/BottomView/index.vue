            ...
            <div class="chart-wrapper">
              ...
              <div class="table-wrapper">
                <el-table :data="tableData">
                  ...
                  <el-table-column porp="kewword" label="关键词" width="180"/>
                  <el-table-column porp="count" label="总搜索量" width="180"/>
                  <el-table-column porp="" label="搜索用户数"/>
                </el-table>
                <el-pagination/>
              </div>
            </div>
        ...
        <el-card shadow="hover">
          <template v-slot:header>
            <div class="title-wrapper">
              <div class="title-warpper">分类销售排行</div>
